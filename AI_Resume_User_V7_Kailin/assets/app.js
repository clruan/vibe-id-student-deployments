(function () {
  ...
  if (!data) {
    throw new Error("Kailin V7 could not find an active profile. Check assets/data/kailin.js and the profile query string.");
  }
  ...
  document.body.setAttribute("data-profile", window.resumeCandidateId || data.id || "");
