...
(function () {
  ...
  function normalizeData(data, id) {
    ...
    data.projects.forEach(function (project, index) {
      ...
      project.stages = Array.isArray(project.stages) && project.stages.length
        ? project.stages
        : (data.disableAutoProjectStages ? [] : fallbackStages(project));
  ...
  var activeProfileId = getProfileIdFromUrl() || normalizeProfileId("ruihang") || profileIds[0];
